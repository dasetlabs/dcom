...
from config import USE_AUX, MODEL_TYPE, PADDING_LEN, VOCAB_SIZE, TRAIN_CSV_PATH, VALID_CSV_PATH, BATCH_SIZE, \
    OPTIMIZER, MODEL_SAVE_DIR, INITIAL_METADATA_PATH, INITIAL_MODEL_WEIGHT_PATH, TRAINING_EPOCHS
...
def train():
    ...
    model.fit(train, valid, BATCH_SIZE, OPTIMIZER, MODEL_SAVE_DIR, TRAINING_EPOCHS, initial_model_weight_path, initial_metadata_path)
